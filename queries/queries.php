...
define('ALMACENAMIENTO_QUERY', '
    query {
        getProductoListing(defaultLanguage: "es", filter: "{\"Tipo\": \"disco duro\"}") {
            edges {
                node {
                    id
                    modificationDate
...
define('RAM_QUERY', '
    query {
        getProductoListing(defaultLanguage: "es", filter: "{\"Tipo\": \"memoria\"}") {
            edges {
                node {
                    id
                    modificationDate
...
define('CPU_QUERY', '
    query {
        getProductoListing(defaultLanguage: "es", filter: "{\"Tipo\": \"cpu\"}") {
            edges {
                node {
                    id
                    modificationDate
...
define('PLACA_BASE_QUERY', '
    query {
        getProductoListing(defaultLanguage: "es", filter: "{\"Tipo\": \"placa base\"}") {
            edges {
                node {
                    id
                    modificationDate
